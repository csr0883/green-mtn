    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Study Time by Students</h1>
          ...
          <h2 class="sub-header">Individual Student Grades and Study Time</h2>
          <div class="table-responsive">
            <table class="table table-striped failure-table">
              ...
              <tbody>
                <?                
                  $myQuery = getQuery('studytime',true); //get the result array
