<div class="col-sm-3 col-md-2 sidebar">
  <ul class="nav nav-sidebar nav-group-1">
  ...
  <ul class="nav nav-sidebar nav-group-2">
    <li class="<?=$pageName == 'traveltime' ? 'active' : '' ?>"><a href="travel-time.php">Travel Time</a></li>
    <li class="<?=$pageName == 'overallhealth' ? 'active' : '' ?>"><a href="overall-health.php">Overall Health</a></li>
  </ul>
